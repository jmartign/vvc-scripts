                   ...
                   time_t start, time_t end, time_t now, int quiet)
{
    ...
    if (renew) {
        fputs("  The certificate needs to be renewed\n\n"
              "  Clients will not be able to correctly connect to this\n"
              "  server using SSL until the certificate is renewed.\n",
              out);
    } else {
        ...
        fprintf(out, 
                ...
                "  Clients will not be able to correctly connect to this\n"
                "  server using SSL until the certificate becomes valid.\n", 
                until);
    }

    fputs("\n"
          " ##########################################################\n"
          "                                  Generated by certwatch\n\n",
          out);
    return 1;
}
