...
--location=http://hut.chepkov.lan/iso/centos \
--extra-args="selinux=0 noipv6 headless ip=$ADDR netmask=255.255.255.0 gateway=10.10.10.250 dns=10.10.10.100 ks=http://chepkov.com/svn/cfg/clusters/cluster3l/kickstart.cfg ksdevice=eth0"
